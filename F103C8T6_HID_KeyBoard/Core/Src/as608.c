...
int light_start_close(void)//¹Ø±ÕÉÏµç×Ô¶¯ÁÁµÆ
{
	recv_end_flag_3=0;
	u8 cmd = 0x3c;
	u8 ctrl = 0xf5;
...
int light_start_open(void)//¿ªÆôÉÏµç×Ô¶¯ÁÁµÆ
{
	recv_end_flag_3=0;
	u8 cmd = 0x3c;
	u8 ctrl = 0xf6;
...
int light_start_setup(void)//ÉèÖÃÉÏµç×Ô¶¯ÁÁµÆ
{
	recv_end_flag_3=0;
	u8 cmd = 0x3c;
	u8 ctrl = 0xfa;
...
int light_setup_sucess(void)//³É¹¦Ä¬ÈÏÁÁµÆÑÕÉ«ÉèÖÃ ÂÌ
{
	recv_end_flag_3=0;
	u8 cmd = 0x3c;
	u8 ctrl = 0xfb;
...
int light_setup_fail(void)//Ê§°ÜÄ¬ÈÏÁÁµÆÑÕÉ«ÉèÖÃ ºì
{
	recv_end_flag_3=0;
	u8 cmd = 0x3c;
	u8 ctrl = 0xfc;
